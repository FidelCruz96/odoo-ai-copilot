...
class TestMetrics(unittest.TestCase):
    ...
    def test_detect_catalog_intent(self):
        ...
        self.assertEqual(matcher.detect_catalog_intent("top ventas")[0], "top_ventas_por_monto")
        self.assertEqual(matcher.detect_catalog_intent("ventas más altas")[0], "top_ventas_por_monto")
        self.assertEqual(matcher.detect_catalog_intent("top cliente por monto")[0], "top_cliente_por_monto")
        self.assertEqual(matcher.detect_catalog_intent("top compras")[0], "top_compras_por_monto")
        self.assertEqual(matcher.detect_catalog_intent("compras más altas")[0], "top_compras_por_monto")
        self.assertEqual(matcher.detect_catalog_intent("top proveedor por compras")[0], "top_proveedor_por_compras")
        self.assertEqual(matcher.detect_catalog_intent("top facturas")[0], "top_facturas_por_monto")
        self.assertEqual(matcher.detect_catalog_intent("facturación más alta")[0], "top_facturas_por_monto")
