...
class Settings:
    ...
    rag_context_chunks: int = int(os.getenv("RAG_CONTEXT_CHUNKS", "3"))
    rag_context_chars: int = int(os.getenv("RAG_CONTEXT_CHARS", "500"))
    rag_max_completion_tokens: int = int(os.getenv("RAG_MAX_COMPLETION_TOKENS", "220"))
